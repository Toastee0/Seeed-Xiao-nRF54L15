...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HPF_GPIO_BACKEND_ICMSG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x17a000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x2003d000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_VPR_LAUNCHER, 0x17a000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x3000);
