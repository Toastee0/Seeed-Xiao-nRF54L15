...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 96);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x165000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x20028000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_VPR_LAUNCHER, 0x165000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x18000);
