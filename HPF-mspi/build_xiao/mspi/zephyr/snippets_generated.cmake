...
# Appends for board regular expression '.*/cpuapp'
if("${BOARD}${BOARD_QUALIFIERS}" MATCHES "^.*/cpuapp$")
  zephyr_set(EXTRA_DTC_OVERLAY_FILE "C:/ncs/v3.1.0/nrf/snippets/hpf/mspi/hpf-mspi-app.overlay" SCOPE snippets APPEND)
  zephyr_set(EXTRA_CONF_FILE "C:/ncs/v3.1.0/nrf/snippets/hpf/mspi/app.conf" SCOPE snippets APPEND)
endif()
# Appends for board regular expression '.*/nrf54l15/cpuapp'
if("${BOARD}${BOARD_QUALIFIERS}" MATCHES "^.*/nrf54l15/cpuapp$")
  zephyr_set(EXTRA_DTC_OVERLAY_FILE "C:/ncs/v3.1.0/nrf/snippets/hpf/mspi/soc/nrf54l15_cpuapp.overlay" SCOPE snippets APPEND)
endif()
# Appends for board regular expression 'nrf54l15dk/nrf54l15/cpuapp'
if("${BOARD}${BOARD_QUALIFIERS}" MATCHES "^nrf54l15dk/nrf54l15/cpuapp$")
  zephyr_set(EXTRA_DTC_OVERLAY_FILE "C:/ncs/v3.1.0/nrf/snippets/hpf/mspi/board/nrf54l15dk_nrf54l15_cpuapp.overlay" SCOPE snippets APPEND)
endif()
