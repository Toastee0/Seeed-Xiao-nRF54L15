...
set(NRFXLIB_DIR          C:/ncs/v3.2.0-preview2/nrfxlib            CACHE STRING "nrfxlib folder")
set(NRF_SECURITY_ROOT    C:/ncs/v3.2.0-preview2/nrf/subsys/nrf_security          CACHE STRING "nrf_security root folder")
set(OBERON_PSA_CORE_PATH C:/ncs/v3.2.0-preview2/modules/crypto/oberon-psa-crypto  CACHE STRING "oberon-psa-core folder")
set(ARM_MBEDTLS_PATH     C:/ncs/v3.2.0-preview2/modules/crypto/mbedtls            CACHE STRING "Mbed TLS folder")
set(NRF_DIR              C:/ncs/v3.2.0-preview2/nrf                              CACHE STRING "NRF folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    M:/nRF54L15/bluetooth/channel_sounding_ras_reflector_new/build_dk/channel_sounding_ras_reflector_new/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      M:/nRF54L15/bluetooth/channel_sounding_ras_reflector_new/build_dk/channel_sounding_ras_reflector_new/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
