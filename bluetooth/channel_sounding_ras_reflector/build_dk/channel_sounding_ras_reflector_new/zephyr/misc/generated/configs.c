...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 3200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_BT_CS_ANTENNA_SWITCH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CHANNEL_SOUNDING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_ROLE_REFLECTOR_ONLY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_MAX_ANTENNA_PATHS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_NUM_ANTENNAS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_EVENT_LEN_DEFAULT, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_T_PM_LEN_10_US, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_T_PM_LEN_DEFAULT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_AUTO_ALLOC_INSTANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_MAX_ACTIVE_CONN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_RD_BUFFERS_PER_CONN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RRSP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_MAX_ANTENNA_PATHS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_SIZE, 1920);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_NEED_ECC_KEY_GEN_PKE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TRANSMIT_POWER_CONTROL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_CNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LE_POWER_CONTROL, 1);
