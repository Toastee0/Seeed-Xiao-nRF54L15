...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CENTRAL_ACL_EVENT_SPACING_DEFAULT, 90000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CHANNEL_SOUNDING_TEST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_ROLE_BOTH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_SIZE, 5600);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_PREPARE_COUNT, 3);
