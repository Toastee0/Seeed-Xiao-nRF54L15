...
MEMORY
{
    RAM (rwx) : ORIGIN = 0x2003c400, LENGTH = ((15) << 10)
...
virtio_driver_api_area : SUBALIGN(4) { _virtio_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._virtio_driver_api.static.*))); _virtio_driver_api_list_end = .;; } > RAM
ztest :
{
