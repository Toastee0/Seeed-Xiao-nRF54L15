...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 1512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_HPF_GPIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_VEVIF_EVENT_RX_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_VEVIF_TASK_TX_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_VPR_COPROCESSOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 244);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x3d000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_HPF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_HPF_INIT_PRIORITY, 48);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_HPF_GPIO_BACKEND_ICMSG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HPF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_NRF_VEVIF_EVENT_RX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_VPR_LAUNCHER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_VPR_LAUNCHER_INIT_PRIORITY, 0);
