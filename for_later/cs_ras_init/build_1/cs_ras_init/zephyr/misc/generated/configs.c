...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_NRF_GRTC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_RADIO_ENABLE_FAST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SW_SWITCH_SINGLE_TIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TICKER_CNTR_FREE_RUNNING, 1);
